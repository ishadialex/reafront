  ...
  return (
    <>
      ...
      >
        ...
        <div className="absolute right-0 top-0 z-[-1] hidden opacity-30 sm:block lg:opacity-100">
          <svg
            width="450"
            height="556"
            viewBox="0 0 450 556"
        ...
        <div className="absolute bottom-0 left-0 z-[-1] hidden opacity-30 sm:block lg:opacity-100">
          <svg
            width="364"
            height="201"
            viewBox="0 0 364 201"
